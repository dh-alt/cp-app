...
const AddVan = (props) => {
  ...
  const van = props.added ? props.items[0] : props.location.state ;   
...
function mapState(state) {
  const {adding, items, added} = state.vans;
  const {alert} = state;
  return {adding, items, added, alert};
}

const actionCreators = {
  addVan: vanActions.add,
  clearAlerts: alertActions.clear,
};

const connectedAddVan = connect(mapState, actionCreators)(AddVan);
export {connectedAddVan as AddVanPage};
